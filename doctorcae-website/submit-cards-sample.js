...
// Optional: BEHIND_THE_BEHAVIOR_SAMPLE_PATH (default: /cards-sample/behind-the-behavior-sample.pdf — same folder as landing page, like toolkit-sample PDF)
...
function samplePdfAbsoluteUrl(req) {
  var path = String(
    process.env.BEHIND_THE_BEHAVIOR_SAMPLE_PATH ||
      '/cards-sample/behind-the-behavior-sample.pdf',
  ).trim();
